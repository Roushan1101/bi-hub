define(["require", "exports", "tslib", "react", "@uifabric/merge-styles", "@uifabric/styling", "@uifabric/utilities", "../slots", "../utilities"], function (require, exports, tslib_1, React, merge_styles_1, styling_1, utilities_1, slots_1, utilities_2) {
    "use strict";
        ...
        var result = function (componentProps) {
            ...
            if (displayName) {
                ...
                if (componentProps.styles) {
                    ...
                    styles = styling_1.concatStyleSets(styles, userStyles);
                    if (userStyles) {
            ...
            var Slots = typeof options.slots === 'function' ? slots_1.getSlots(viewProps, options.slots(viewProps)) : slots_1.getSlots(viewProps, options.slots);
