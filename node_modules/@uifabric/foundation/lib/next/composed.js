...
export function composed(baseComponentOrOptions, recompositionOptions) {
    ...
    var result = function (componentProps) {
        ...
        if (useState) {
            ...
            componentProps = __assign(__assign({}, componentProps), useState(componentProps));
        }
        ...
        var Slots = typeof options.slots === 'function' ? getSlots(viewProps, options.slots(viewProps)) : getSlots(viewProps, options.slots);
