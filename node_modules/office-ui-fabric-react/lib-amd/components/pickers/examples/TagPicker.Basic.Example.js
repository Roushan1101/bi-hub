define(["require", "exports", "tslib", "react", "office-ui-fabric-react/lib/Pickers", "office-ui-fabric-react/lib/Checkbox", "office-ui-fabric-react/lib/Styling"], function (require, exports, tslib_1, React, Pickers_1, Checkbox_1, Styling_1) {
    "use strict";
    ...
    var TagPickerBasicExample = /** @class */ (function (_super) {
        ...
        TagPickerBasicExample.prototype.render = function () {
            return (React.createElement("div", { className: rootClass },
                React.createElement(Checkbox_1.Checkbox, { styles: { root: { margin: '10px 0' } }, label: "Disable Tag Picker", checked: this.state.isPickerDisabled, onChange: this._onDisabledButtonClick }),
