define(["require", "exports", "tslib", "react", "office-ui-fabric-react/lib/Pivot"], function (require, exports, tslib_1, React, Pivot_1) {
    "use strict";
    ...
    var PivotSeparateExample = /** @class */ (function (_super) {
        ...
        PivotSeparateExample.prototype.render = function () {
            return (React.createElement("div", null,
                React.createElement("div", { "aria-labelledby": this._getTabId(this.state.selectedKey), role: "tabpanel", style: {
                        float: 'left',
                        width: 100,
                        height: this.state.selectedKey === 'squareRed' ? 100 : 200,
                        background: this.state.selectedKey === 'rectangleGreen' ? 'green' : 'red'
                    } }),
                React.createElement(Pivot_1.Pivot, { "aria-label": "Separately Rendered Content Pivot Example", selectedKey: this.state.selectedKey, onLinkClick: this._handleLinkClick, headersOnly: true, getTabId: this._getTabId },
