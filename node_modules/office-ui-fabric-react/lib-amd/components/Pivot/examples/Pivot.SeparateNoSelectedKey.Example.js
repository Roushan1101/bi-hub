define(["require", "exports", "tslib", "react", "office-ui-fabric-react/lib/Pivot", "office-ui-fabric-react/lib/Button"], function (require, exports, tslib_1, React, Pivot_1, Button_1) {
    ...
    var PivotSeparateNoSelectedKeyExample = /** @class */ (function (_super) {
        ...
        PivotSeparateNoSelectedKeyExample.prototype.render = function () {
            ...
            var items = tslib_1.__assign(tslib_1.__assign({}, pivotItems), { Settings: React.createElement("div", null, "settings") });
            return (React.createElement("div", { style: { width: '50%', maxWidth: '500px' } },
                ...
                React.createElement("div", { style: {
                    ...
                    React.createElement(Pivot_1.Pivot, { "aria-label": "No Selected Pivot Example", style: { flexGrow: 1 }, selectedKey: Object.keys(pivotItems).indexOf(this.state.selectedKey) >= 0 ? this.state.selectedKey : null, onLinkClick: this._handleLinkClick, headersOnly: true, getTabId: this._getTabId }, Object.keys(pivotItems).map(function (name) { return (React.createElement(Pivot_1.PivotItem, { key: "pivotItemKey_" + name, headerText: name, itemKey: name })); })),
                    React.createElement(Button_1.DefaultButton, { iconProps: { iconName: 'Settings', style: { color: this.state.selectedKey === 'Settings' ? 'blue' : 'black' } }, onClick: this._handleSettingsIconClick, text: "Settings" })),
