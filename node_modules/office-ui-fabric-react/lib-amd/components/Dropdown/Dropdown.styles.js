define(["require", "exports", "tslib", "../../Utilities", "../../utilities/positioning", "../../Styling"], function (require, exports, tslib_1, Utilities_1, positioning_1, Styling_1) {
    "use strict";
    var _a, _b, _c;
        ...
        return {
            ...
            title: [
                ...
                disabled && {
                    ...
                    color: semanticColors.disabledText,
                    cursor: 'default',
                    selectors: (_g = {}, _g[Styling_1.HighContrastSelector] = { border: '1px solid GrayText', color: 'GrayText' }, _g)
                }
            ],
            caretDownWrapper: [
            ...
            caretDown: [
                ...
                disabled && { color: semanticColors.disabledText, selectors: (_h = {}, _h[Styling_1.HighContrastSelector] = { color: 'GrayText' }, _h) }
            ],
            ...
            dropdownItemHeader: [
                ...
                tslib_1.__assign(tslib_1.__assign({}, fonts.medium), { fontWeight: Styling_1.FontWeights.semibold, color: semanticColors.menuHeader, background: 'none', backgroundColor: 'transparent', border: 'none', height: DROPDOWN_ITEM_HEIGHT, lineHeight: DROPDOWN_ITEM_HEIGHT, cursor: 'default', padding: '0 8px', userSelect: 'none', textAlign: 'left' })
            ],
            subComponentStyles: {
