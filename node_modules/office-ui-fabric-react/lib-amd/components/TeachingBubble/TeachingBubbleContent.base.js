define(["require", "exports", "tslib", "react", "../../Utilities", "../../Button", "../../Image", "../../Stack", "../../FocusTrapZone"], function (require, exports, tslib_1, React, Utilities_1, Button_1, Image_1, Stack_1, FocusTrapZone_1) {
    ...
    var TeachingBubbleContentBase = /** @class */ (function (_super) {
        ...
        TeachingBubbleContentBase.prototype.render = function () {
            var _a = this.props, children = _a.children, illustrationImage = _a.illustrationImage, primaryButtonProps = _a.primaryButtonProps, secondaryButtonProps = _a.secondaryButtonProps, headline = _a.headline, hasCondensedHeadline = _a.hasCondensedHeadline, _b = _a.hasCloseButton, hasCloseButton = _b === void 0 ? this.props.hasCloseIcon : _b, onDismiss = _a.onDismiss, closeButtonAriaLabel = _a.closeButtonAriaLabel, hasSmallHeadline = _a.hasSmallHeadline, isWide = _a.isWide, styles = _a.styles, theme = _a.theme, ariaDescribedBy = _a.ariaDescribedBy, ariaLabelledBy = _a.ariaLabelledBy, customFooterContent = _a.footerContent;
            var imageContent;
            var headerContent;
            var bodyContent;
            var footerContent;
