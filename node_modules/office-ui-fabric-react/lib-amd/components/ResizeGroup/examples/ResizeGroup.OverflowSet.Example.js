define(["require", "exports", "tslib", "react", "office-ui-fabric-react/lib/Utilities", "office-ui-fabric-react/lib/Button", "office-ui-fabric-react/lib/ResizeGroup", "office-ui-fabric-react/lib/OverflowSet", "office-ui-fabric-react/lib/Checkbox", "office-ui-fabric-react/lib/Dropdown", "office-ui-fabric-react"], function (require, exports, tslib_1, React, Utilities_1, Button_1, ResizeGroup_1, OverflowSet_1, Checkbox_1, Dropdown_1, office_ui_fabric_react_1) {
    "use strict";
            ...
            return (React.createElement("div", { className: short ? styles.resizeIsShort : 'notResized' },
                React.createElement(ResizeGroup_1.ResizeGroup, { role: "tabpanel", "aria-label": "Resize Group with an Overflow Set", data: dataToRender, onReduceData: this._onReduceData, onGrowData: onGrowDataEnabled ? this._onGrowData : undefined, 
                    ...
                    onRenderData: function (data) {
                        return (React.createElement(OverflowSet_1.OverflowSet, { role: "menubar", items: data.primary, overflowItems: data.overflow.length ? data.overflow : null, onRenderItem: function (item) {
                                return (React.createElement(Button_1.CommandBarButton, { role: "menuitem", text: item.name, iconProps: { iconName: item.icon }, onClick: item.onClick, checked: item.checked }));
                            }, onRenderOverflowButton: function (overflowItems) {
                                return React.createElement(Button_1.CommandBarButton, { role: "menuitem", menuProps: { items: overflowItems } });
