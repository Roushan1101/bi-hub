...
exports.PersonaAlternateExample = function () {
    ...
    return (React.createElement(Stack_1.Stack, { tokens: { childrenGap: 10 } },
        ...
        React.createElement(Persona_1.Persona, tslib_1.__assign({}, examplePersona, { size: Persona_1.PersonaSize.size28, presence: Persona_1.PersonaPresence.none, imageAlt: "Annie Ried, status is unknown" })),
