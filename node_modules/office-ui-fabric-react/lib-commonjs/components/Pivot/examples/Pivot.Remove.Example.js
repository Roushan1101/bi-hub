...
var PivotRemoveExample = /** @class */ (function (_super) {
    ...
    PivotRemoveExample.prototype.render = function () {
        ...
        return (React.createElement("div", null,
            React.createElement(Pivot_1.Pivot, { "aria-label": "Remove Pivot Example", linkSize: Pivot_1.PivotLinkSize.large, linkFormat: Pivot_1.PivotLinkFormat.tabs }, pivotArray),
            React.createElement("div", null,
                React.createElement(Button_1.DefaultButton, { "aria-live": "polite", onClick: this._handleClick, text: (this.state.shouldShowFirstPivotItem ? 'Hide' : 'Show') + " First Pivot Item" }))));
    };
