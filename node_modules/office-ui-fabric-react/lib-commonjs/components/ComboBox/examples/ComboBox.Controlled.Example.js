...
var ComboBoxControlledExample = /** @class */ (function (_super) {
    ...
    function ComboBoxControlledExample(props) {
        ...
        _this._getOptions = function (currentOptions) {
            ...
            var options = tslib_1.__spreadArrays(INITIAL_OPTIONS);
            _this.setState({
                options: options,
                selectedOptionKey: 'C',
        ...
        _this._onChange = function (event, option, index, value) {
            ...
            if (option) {
                ...
                _this.setState({
                    options: tslib_1.__spreadArrays(_this.state.options, [newOption]),
        ...
        _this._onChangeMulti = function (event, option, index, value) {
            ...
            if (option) {
                ...
                var newOption = { key: value, text: value };
                var updatedSelectedKeys = tslib_1.__spreadArrays(currentSelectedKeys, [newOption.key]);
                _this.setState({
                    optionsMulti: tslib_1.__spreadArrays(_this.state.optionsMulti, [newOption]),
                    selectedOptionKeys: updatedSelectedKeys
                });
            }
        };
        _this._updateSelectedOptionKeys = function (selectedKeys, option) {
            selectedKeys = tslib_1.__spreadArrays(selectedKeys); // modify a copy
