...
var KeytipsDynamicExample = /** @class */ (function (_super) {
    ...
    KeytipsDynamicExample.prototype.render = function () {
        ...
        return (React.createElement("div", null,
            ...
            React.createElement(Button_1.DefaultButton, { text: "Button 1", onClick: this.setCurrButton('Button 1'), keytipProps: { content: 'GG1', keySequences: ['gg1'], onExecute: this.setCurrButton('Button 1'), hasDynamicChildren: true } }),
            React.createElement(Button_1.DefaultButton, { text: "Button 2", onClick: this.setCurrButton('Button 2'), keytipProps: { content: 'GG2', keySequences: ['gg2'], onExecute: this.setCurrButton('Button 2'), hasDynamicChildren: true } }),
