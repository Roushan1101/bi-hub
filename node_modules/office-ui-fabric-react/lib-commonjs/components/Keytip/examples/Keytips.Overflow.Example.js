...
var KeytipSetup_1 = require("office-ui-fabric-react/lib/components/Keytip/examples/KeytipSetup");
...
var KeytipsOverflowExample = /** @class */ (function (_super) {
    ...
    KeytipsOverflowExample.prototype.render = function () {
        return (React.createElement("div", null,
            ...
            React.createElement(OverflowSet_1.OverflowSet, { role: "menubar", styles: { root: { marginBottom: 28 } }, items: this.state.items, overflowItems: this.state.overflowItems, keytipSequences: KeytipSetup_1.keytipMap.OverflowButton4.keySequences, onRenderOverflowButton: this._onRenderOverflowButton, onRenderItem: this._onRenderItem }),
    ...
    KeytipsOverflowExample.prototype._onRenderItem = function (item) {
        return (React.createElement(Button_1.CommandBarButton, tslib_1.__assign({ role: "menuitem" }, item, { styles: { root: { padding: '10px' } }, menuProps: item.subMenuProps }), item.name));
    };
