...
var options = [
    {
        ...
        onRenderField: function (props, render) {
            return (React.createElement("div", { className: optionRootClass },
                render(props),
                React.createElement(Dropdown_1.Dropdown, { defaultSelectedKey: "A", styles: dropdownStyles, options: dropdownOptions, disabled: props ? !props.checked : false, ariaLabel: "Select a time span" })));
        }
    },
