    ...
    ResizeGroupVerticalOverflowSetExample.prototype.render = function () {
        ...
        return (React.createElement(office_ui_fabric_react_1.ResizeGroup, { className: resizeRootClassName, role: "tabpanel", "aria-label": "Vertical Resize Group with an Overflow Set", direction: office_ui_fabric_react_1.ResizeGroupDirection.vertical, data: dataToRender, onReduceData: this._onReduceData, 
            ...
            onRenderData: function (data) {
                return (React.createElement(office_ui_fabric_react_1.OverflowSet, { role: "menubar", vertical: true, items: data.primary, overflowItems: data.overflow.length ? data.overflow : null, onRenderItem: function (item) {
                        return (React.createElement(office_ui_fabric_react_1.CommandBarButton, { role: "menuitem", text: item.name, iconProps: { iconName: item.icon }, onClick: item.onClick, checked: item.checked, styles: buttonStyles }));
                    }, onRenderOverflowButton: function (overflowItems) {
                        return (React.createElement(office_ui_fabric_react_1.CommandBarButton, { role: "menuitem", styles: buttonStyles, menuIconProps: { iconName: 'ChevronRight' }, menuProps: { items: overflowItems, directionalHint: office_ui_fabric_react_1.DirectionalHint.rightCenter } }));
                    } }));
            } }));
    };
