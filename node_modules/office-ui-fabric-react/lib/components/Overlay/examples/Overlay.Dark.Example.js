...
var OverlayDarkExample = /** @class */ (function (_super) {
    ...
    OverlayDarkExample.prototype.render = function () {
        ...
        return (React.createElement("div", null,
            React.createElement(DefaultButton, { onClick: this._toggleOverlay, text: "Show the overlay" }),
            isOverlayVisible && (React.createElement(Overlay, { isDarkThemed: true, onClick: this._setVisibilityFalse },
