...
export var ContextualMenuCustomizationExample = function () {
...
function renderCharmMenuItem(item, dismissMenu) {
    return (React.createElement(IconButton, { iconProps: { iconName: item.text }, className: "ms-ContextualMenu-customizationExample-icon ms-ContextualMenu-link", "data-is-focusable": true, onClick: dismissMenu }));
}
function renderCategoriesList(item) {
    return (React.createElement("ul", { className: "ms-ContextualMenu-customizationExample-categoriesList" },
        React.createElement("li", { className: "ms-ContextualMenu-item" }, item.categoryList.map(function (category) { return (React.createElement(DefaultButton, { className: "ms-ContextualMenu-link ms-ContextualMenu-customizationExample-button", role: "menuitem", key: category.name },
