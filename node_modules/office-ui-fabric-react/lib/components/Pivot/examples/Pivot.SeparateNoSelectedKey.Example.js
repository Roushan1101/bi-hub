    ...
    PivotSeparateNoSelectedKeyExample.prototype.render = function () {
        ...
        return (React.createElement("div", { style: { width: '50%', maxWidth: '500px' } },
            ...
            React.createElement("div", { style: {
                ...
                React.createElement(DefaultButton, { iconProps: { iconName: 'Settings', style: { color: this.state.selectedKey === 'Settings' ? 'blue' : 'black' } }, onClick: this._handleSettingsIconClick, text: "Settings" })),
