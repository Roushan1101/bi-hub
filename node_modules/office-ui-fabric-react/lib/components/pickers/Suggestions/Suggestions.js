...
var Suggestions = /** @class */ (function (_super) {
    ...
    Suggestions.prototype.render = function () {
        ...
        return (React.createElement("div", __assign({ className: this._classNames.root }, divProps),
            ...
            forceResolveText && this._shouldShowForceResolve() && (React.createElement(CommandButton, { componentRef: this._forceResolveButton, className: this._classNames.forceResolveButton, onClick: this._forceResolve, "data-automationid": 'sug-forceResolve' }, forceResolveText)),
