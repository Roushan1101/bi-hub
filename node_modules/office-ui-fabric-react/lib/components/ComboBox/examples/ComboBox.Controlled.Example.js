...
var ComboBoxControlledExample = /** @class */ (function (_super) {
    __extends(ComboBoxControlledExample, _super);
    function ComboBoxControlledExample(props) {
        ...
        _this._getOptions = function (currentOptions) {
            ...
            var options = __spreadArrays(INITIAL_OPTIONS);
            _this.setState({
                options: options,
                selectedOptionKey: 'C',
        ...
        _this._onChange = function (event, option, index, value) {
            ...
            if (option) {
                ...
                _this.setState({
                    options: __spreadArrays(_this.state.options, [newOption]),
        ...
        _this._onChangeMulti = function (event, option, index, value) {
            ...
            if (option) {
                ...
                var newOption = { key: value, text: value };
                var updatedSelectedKeys = __spreadArrays(currentSelectedKeys, [newOption.key]);
                _this.setState({
                    optionsMulti: __spreadArrays(_this.state.optionsMulti, [newOption]),
                    selectedOptionKeys: updatedSelectedKeys
                });
            }
        };
        _this._updateSelectedOptionKeys = function (selectedKeys, option) {
            selectedKeys = __spreadArrays(selectedKeys); // modify a copy
    ...
    ComboBoxControlledExample.prototype.render = function () {
        ...
        return (React.createElement(Fabric, { className: wrapperClassName },
            React.createElement(ComboBox, { selectedKey: state.selectedOptionKey, label: "Controlled single-select ComboBox (allowFreeform: T)", allowFreeform: true, autoComplete: "on", options: state.options, onChange: this._onChange, onResolveOptions: this._getOptions, text: state.initialDisplayValue }),
            React.createElement(ComboBox, { multiSelect: true, selectedKey: state.selectedOptionKeys, label: "Controlled multi-select ComboBox (allowFreeform: T)", allowFreeform: true, autoComplete: "on", options: state.optionsMulti, onChange: this._onChangeMulti, onResolveOptions: this._getOptionsMulti, text: state.initialDisplayValueMulti })));
    };
