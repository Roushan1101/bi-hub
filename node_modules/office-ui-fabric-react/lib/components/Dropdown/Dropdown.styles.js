...
import { FontWeights, HighContrastSelector, getGlobalClassNames, normalize, HighContrastSelectorWhite, getScreenSelector, ScreenWidthMinMedium } from '../../Styling';
    ...
    return {
        ...
        title: [
            ...
            disabled && {
                ...
                color: semanticColors.disabledText,
                cursor: 'default',
                selectors: (_g = {}, _g[HighContrastSelector] = { border: '1px solid GrayText', color: 'GrayText' }, _g)
            }
        ],
        caretDownWrapper: [
        ...
        caretDown: [
            ...
            disabled && { color: semanticColors.disabledText, selectors: (_h = {}, _h[HighContrastSelector] = { color: 'GrayText' }, _h) }
        ],
        ...
        dropdownItemHeader: [
            ...
            __assign(__assign({}, fonts.medium), { fontWeight: FontWeights.semibold, color: semanticColors.menuHeader, background: 'none', backgroundColor: 'transparent', border: 'none', height: DROPDOWN_ITEM_HEIGHT, lineHeight: DROPDOWN_ITEM_HEIGHT, cursor: 'default', padding: '0 8px', userSelect: 'none', textAlign: 'left' })
        ],
        subComponentStyles: {
