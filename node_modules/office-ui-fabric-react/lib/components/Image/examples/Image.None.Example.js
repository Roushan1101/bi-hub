...
var ImageNoneExample = /** @class */ (function (_super) {
    ...
    ImageNoneExample.prototype.render = function () {
        ...
        return (React.createElement("div", null,
            ...
            React.createElement(Image, __assign({}, imageProps, { alt: "Example implementation of the property image fit using the none value on an image larger than the frame." })),
            ...
            React.createElement(Image, __assign({}, imageProps, { src: "http://placehold.it/100x100", alt: "Example implementation of the property image fit using the none value on an image smaller than the frame." }))));
    };
