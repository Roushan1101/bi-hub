    ...
    var renderedElements = shimmerElements ? (shimmerElements.map(function (element, index) {
        ...
        switch (element.type) {
            case ShimmerElementType.circle:
                return React.createElement(ShimmerCircle, __assign({ key: index }, filteredElem, { styles: getElementStyles(element, backgroundColor, rowHeight) }));
            case ShimmerElementType.gap:
                return React.createElement(ShimmerGap, __assign({ key: index }, filteredElem, { styles: getElementStyles(element, backgroundColor, rowHeight) }));
            case ShimmerElementType.line:
                return React.createElement(ShimmerLine, __assign({ key: index }, filteredElem, { styles: getElementStyles(element, backgroundColor, rowHeight) }));
        }
