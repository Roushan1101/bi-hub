...
var ShimmerStylingExample = /** @class */ (function (_super) {
    __extends(ShimmerStylingExample, _super);
    ...
    ShimmerStylingExample.prototype.render = function () {
        return (React.createElement(React.Fragment, null,
            ...
            React.createElement("div", { className: classNames.themedBackgroundWrapper2 },
                React.createElement(Shimmer, { customElementsGroup: this._getCustomElements(customThemeForShimmer.palette.white), width: 300, shimmerColors: {
                        shimmer: customThemeForShimmer.palette.themeTertiary,
                        shimmerWave: customThemeForShimmer.palette.themeSecondary
                    } })),
            React.createElement("div", null,
            ...
            React.createElement(Customizer, { settings: { theme: __assign({}, customThemeForShimmer) } },
                React.createElement("div", { className: classNames.themedBackgroundWrapper2 },
                    React.createElement(Shimmer, { customElementsGroup: this._getCustomElements(), width: 300 }))),
            React.createElement("div", null,
            ...
            React.createElement("div", { className: classNames.wrapper },
                React.createElement(Shimmer, { width: "75%", styles: this._getShimmerStyles }),
                React.createElement(Shimmer, { width: "75%", styles: this._getShimmerStyles }),
                React.createElement(Shimmer, { width: "75%", styles: this._getShimmerStyles }),
                React.createElement(Shimmer, { width: "75%", styles: this._getShimmerStyles }),
                React.createElement(Shimmer, { width: "75%", styles: this._getShimmerStyles }))));
