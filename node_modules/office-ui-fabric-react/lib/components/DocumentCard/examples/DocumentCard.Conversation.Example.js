...
export var DocumentCardConversationExample = function () {
    ...
    return (React.createElement("div", null,
        React.createElement(DocumentCard, { "aria-label": "Document Card with logo, text preview, and status. Conversation about annual report. Content preview. 3 attachments.\n        Sent by Annie Lindqvist and 2 others in March 13, 2018.", styles: cardStyles, onClickHref: "http://bing.com" },
        ...
        React.createElement(DocumentCard, { "aria-label": "Document Card with logo, text preview, and status. Further annual report conversation. Content preview. 3 attachments.\n        Sent by Christian Bergqvist and 2 others in March 13, 2018.", styles: cardStyles, onClickHref: "http://bing.com" },
            React.createElement(DocumentCardLogo, __assign({}, logoProps)),
            React.createElement("div", { className: conversationTileClass },
        ...
        React.createElement(DocumentCard, { "aria-label": "Document Card with logo and text preview. Conversation about annual report. Content preview. Sent by Velatine Lourvric\n        and 1 other in March 13, 2018.", styles: cardStyles, onClickHref: "http://bing.com" },
            React.createElement(DocumentCardLogo, __assign({}, logoProps)),
            React.createElement("div", { className: conversationTileClass },
