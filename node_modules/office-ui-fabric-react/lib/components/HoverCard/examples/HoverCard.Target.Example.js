...
var HoverCardField = /** @class */ (function (_super) {
    __extends(HoverCardField, _super);
    ...
    HoverCardField.prototype.render = function () {
        return (React.createElement("div", { ref: this.targetElementRef, "data-is-focusable": true },
            this.props.content,
            this.state.contentRendered && (React.createElement(HoverCard, { expandingCardProps: this.props.expandingCardProps, target: this.targetElementRef.current, cardDismissDelay: 300, onCardVisible: this._log('onCardVisible'), onCardHide: this._log('onCardHide'), trapFocus: true, openHotKey: KeyCodes.enter }))));
    };
...
var HoverCardTargetExample = /** @class */ (function (_super) {
    __extends(HoverCardTargetExample, _super);
