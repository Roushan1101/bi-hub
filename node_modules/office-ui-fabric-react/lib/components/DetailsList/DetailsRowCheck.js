...
var DetailsRowCheckBase = function (props) {
    ...
    return canSelect ? (React.createElement("div", __assign({}, buttonProps, { role: "checkbox", className: css(classNames.root, classNames.check), "aria-checked": selected, "data-selection-toggle": true, "data-automationid": "DetailsRowCheck" }), onRenderCheckbox(detailsCheckboxProps))) : (React.createElement("div", __assign({}, buttonProps, { className: css(classNames.root, classNames.check) })));
};
