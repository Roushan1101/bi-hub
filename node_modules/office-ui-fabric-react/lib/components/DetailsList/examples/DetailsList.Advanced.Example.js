...
var DetailsListAdvancedExample = /** @class */ (function (_super) {
    ...
    function DetailsListAdvancedExample(props) {
        ...
        _this._onGroupByColumn = function (column) {
            ...
            if (isGrouped) {
                ...
                if (groups) {
                    newGroups = __spreadArrays(groups);
    ...
    DetailsListAdvancedExample.prototype.render = function () {
        ...
        return (React.createElement("div", { className: classNames.root },
            ...
            React.createElement(Announced, { message: this.state.selectionCount + " selected" }),
            ...
            contextualMenuProps && React.createElement(ContextualMenu, __assign({}, contextualMenuProps))));
    };
    DetailsListAdvancedExample.prototype._onDataMiss = function (index) {
        ...
        if (!this._isFetchingItems) {
            ...
            setTimeout(function () {
                ...
                var itemsCopy = __spreadArrays(_this.state.items);
