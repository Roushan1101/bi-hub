...
var DetailsListDocumentsExample = /** @class */ (function (_super) {
    ...
    DetailsListDocumentsExample.prototype.render = function () {
        ...
        return (React.createElement(Fabric, null,
            ...
            announcedMessage ? React.createElement(Announced, { message: announcedMessage }) : undefined,
            isModalSelection ? (React.createElement(MarqueeSelection, { selection: this._selection },
                React.createElement(DetailsList, { items: items, compact: isCompactMode, columns: columns, selectionMode: SelectionMode.multiple, getKey: this._getKey, setKey: "multiple", layoutMode: DetailsListLayoutMode.justified, isHeaderVisible: true, selection: this._selection, selectionPreservedOnEmptyClick: true, onItemInvoked: this._onItemInvoked, enterModalSelectionOnTouch: true, ariaLabelForSelectionColumn: "Toggle selection", ariaLabelForSelectAllCheckbox: "Toggle selection for all items", checkButtonAriaLabel: "Row checkbox" }))) : (React.createElement(DetailsList, { items: items, compact: isCompactMode, columns: columns, selectionMode: SelectionMode.none, getKey: this._getKey, setKey: "none", layoutMode: DetailsListLayoutMode.justified, isHeaderVisible: true, onItemInvoked: this._onItemInvoked }))));
    };
